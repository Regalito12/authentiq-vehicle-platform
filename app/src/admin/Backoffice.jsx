...
function DashboardPulse({ data, leads, offers, appointments, onNavigate }) {
  ...
  return <section className="dashboard-pulse">
    <article className="priority-panel">
      <div className="panel-heading"><div><span className="eyebrow">PRIORIDAD HOY</span><h3>Lo que merece atencion.</h3></div><button className="text-button" type="button" onClick={() => onNavigate("leads")}>Abrir clientes</button></div>
