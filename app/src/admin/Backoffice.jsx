...
function DashboardView({ data, vehicles = [], leads, offers, appointments, loading, error = "", onRetry, onNavigate, onboarding, onOpenOnboarding, onOpenPublic, organization, settings, currentUser }) {
...
function LeadsModule({ records, users, loading, onRefresh, onUpdate, onLoadHistory, onAddAppointment, onCreateQuote, onDirtyChange }) {
