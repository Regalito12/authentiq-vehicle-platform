...
function BackofficeCommandCenter({ open, onOpenChange, role, onNavigate, onPreview, onBack, onOpenOnboarding }) {
  ...
  const quickActions = [{ value: "vista previa showroom", label: "Ver mi showroom", icon: EyeIcon, run: onPreview }, { value: "abrir inicio zevroa", label: "Ir al inicio de ZEVROA", icon: HouseIcon, run: onBack }];
