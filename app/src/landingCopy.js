...
export const LANDING_COPY = {
  es: {
    ...
    rail: {
      ...
      items: [
        { name: "Porsche 911 GT3", meta: "2026 · Deportivo", image: "/assets/porsche-911-gt3.jpg", alt: "Porsche 911 GT3 en el showroom" },
        { name: "Audi RS e-tron GT", meta: "2025 · Eléctrico", image: "/assets/audi-etron-gt.jpg", alt: "Audi RS e-tron GT en el showroom" },
        { name: "BMW M4 Competition", meta: "2024 · Coupé", image: "/assets/bmw-m4.jpg", alt: "BMW M4 Competition en el showroom" },
        ...
        { name: "Porsche Macan GTS", meta: "2026 · SUV", image: "/assets/macan-gts.jpg", alt: "Porsche Macan GTS en el showroom" },
      ],
    },
  ...
  en: {
    ...
    rail: {
      ...
      items: [
        { name: "Porsche 911 GT3", meta: "2026 · Sports", image: "/assets/porsche-911-gt3.jpg", alt: "Porsche 911 GT3 in the showroom" },
        { name: "Audi RS e-tron GT", meta: "2025 · Electric", image: "/assets/audi-etron-gt.jpg", alt: "Audi RS e-tron GT in the showroom" },
        { name: "BMW M4 Competition", meta: "2024 · Coupe", image: "/assets/bmw-m4.jpg", alt: "BMW M4 Competition in the showroom" },
        ...
        { name: "Porsche Macan GTS", meta: "2026 · SUV", image: "/assets/macan-gts.jpg", alt: "Porsche Macan GTS in the showroom" },
      ],
    },
    marqueeBrands: ["Porsche", "BMW", "Mercedes-AMG", "Audi", "Land Rover", "Lexus", "Jaguar", "Alfa Romeo", "Bentley", "Ferrari"],
